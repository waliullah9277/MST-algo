...
class secondMSTPrims {
    ...
    public static void main(String[] args) {
        ...
        Vector<Edge> thirdMST = null;
        for (Edge excludedEdge : firstMST) {
            Vector<Edge> candidateMST = prims(0, excludedEdge);
            int candidateWeight = calculateWeight(candidateMST);

            if (candidateWeight > secondMSTWeight && candidateWeight < thiredMSTWeight) {
        ...
        for (Edge excludedEdge : firstMST) {
            ...
            if (candidateWeight > thiredMSTWeight && candidateWeight < fourMSTWeight) {
